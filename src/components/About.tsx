      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
           I'm a tech enthusiast with an MSc in Computer Applications, passionate about building real-world projects using Java, JavaScript, and modern frameworks like Next.js. I recently developed an AI Career Coach and am actively seeking internship or fresher roles to contribute, learn, and grow.</p>
           <br />
           <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <div className="bg-slate-800/50 backdrop-blur-lg rounded-2xl p-8 border border-slate-700/50 hover:border-blue-500/50 transition-all duration-300">
              ...
              <p className="text-gray-300 leading-relaxed">
                Started my journey in Computer Science at Dr. D Y Patil ACSC College, Pune, and completed my MSc at MIT ACSC. Over the years, I've evolved into a passionate MERN Full Stack Developer with expertise in React.js, Node.js, HTML, CSS, Javascript & building full-stack web applications.
              </p>
            </div>
            ...
            <div className="bg-slate-800/50 backdrop-blur-lg rounded-2xl p-8 border border-slate-700/50 hover:border-purple-500/50 transition-all duration-300">
              ...
              <p className="text-gray-300 leading-relaxed">
                I'm passionate about building responsive web apps, solving real-world problems through elegant full-stack solutions, and participating in coding challenges. I’ve developed impactful projects like Interactive Story Telling and AI Career Coach, blending innovation with practical utility.
              </p>
            </div>
          ...
          <div className="relative">
            <div className="bg-gradient-to-br from-slate-400/20 to-red-600/20 rounded-2xl p-8 backdrop-blur-lg border border-slate-700/50">
