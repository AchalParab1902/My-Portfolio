...
const Experience: React.FC = () => {
  ...
  const education = [
    ...
    },
    {
      ...
      school: `Dr. D Y Patil, ACSC ,Pimpri`,
      period: '2020 - 2023',
 ...
 const certifications = [
  {
    title: 'Certified HTML, CSS, JavaScript Web Developer (Udemy)',
    url: 'https://drive.google.com/file/d/1DFJqUE8VgwMu5XIAcoUBjwh3w9xdXvSQ/view?usp=drive_link',
  },
  {
    title: 'OOPS in Java (Great Learning)',
    url: 'https://drive.google.com/file/d/1TQRLffnu3JfEUqkgVNAfXajy7nwlHgCq/view?usp=drive_link',
  },
  {
    title: 'Java Programming for Beginners (Simplilearn)',
    url: 'https://drive.google.com/file/d/179JwIYuRrYAXGiDwHYLXn-rp2z5Awtbv/view?usp=drive_link',
  },
];
