...
const Contact: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const serviceId = "service_j3ka8xb"; // Your Gmail service ID
    const templateId = "template_bqlhdih"; // Your EmailJS template ID
    const publicKey = "UfRajICwhp081O_eU"; // Your EmailJS public key
  ...
  const contactInfo = [
    {
      icon: Mail,
      title: "Email",
      value: "achalparab19302@gmail.com",
      link: "mailto:achalparab19302@gmail.com",
    },
    {
      icon: Phone,
      title: "Phone",
      value: "+91 9356524438",
      link: "tel:+919356524438",
    },
    {
      icon: MapPin,
      title: "Location",
