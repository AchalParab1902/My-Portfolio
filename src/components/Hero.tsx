        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-12">
            ...
            <p className="text-lg text-gray-400 max-w-3xl mx-auto mb-12 leading-relaxed animate-fade-in-delay-2">
              I'm passionate about building responsive web apps, solving
              real-world problems through elegant full-stack solutions, and
              participating in coding challenges. I’ve developed impactful
              projects like Interractive Story telling and AI Career Coach,
              blending innovation with practical utility.
            </p>
          </div>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-16 animate-fade-in-delay-3">
            <a
              href="https://drive.google.com/file/d/1k3DsYzOPRKPC7rzlT1rKPJMUFkyv1wTn/view?usp=drive_link"
              target="_blank"
          ...
          <div className="flex justify-center space-x-8 mb-8 animate-fade-in-delay-4">
            <a
              href="https://github.com/AchalParab1902"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://www.linkedin.com/in/achalparab"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-white transition-colors duration-300 transform hover:scale-110"
            >
            ...
            <a
              href="mailto:achalparab19302@gmail.com"
              className="text-gray-400 hover:text-white transition-colors duration-300 transform hover:scale-110"
            >
              <Mail size={28} />
            </a>
